...
namespace da_st {
    ...
    template<class element_type>
    void array_list<element_type>::init_array_list(int size) {
    ...
    template<class element_type>
    int array_list<element_type>::get_list_size() {
        if (this->top_index < 0) return 0;
        return this->top_index + 1;
    }

    template<class element_type>
    element_type array_list<element_type>::get(int index) {
        if (index > this->top_index) throw my_exception("Index out of bound");
    ...
    template<class element_type>
    int array_list<element_type>::index_of(element_type obj) {
        return 0;
    }
    ...
    template<class element_type>
    int array_list<element_type>::last_index_of(element_type obj) {
        // TODO:
        return 0;
    }
